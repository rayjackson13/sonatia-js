...
export const TitleBar: FC = () => {
  ...
  return (
    <div id="title-bar" className="flex items-center text-white select-none h-10">
      ...
      <div className="flex w-full justify-center">
        <div className="container flex justify-center align-center relative mr-50">
          {!isHomePage && (
            <button className="absolute left-12 w-20 no-drag px-2 h-full gap-1 text-font-grey" onClick={goBack}>
              <BackArrowIcon /> Back
            </button>
          )}
